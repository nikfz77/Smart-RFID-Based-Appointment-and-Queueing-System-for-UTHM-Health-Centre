...
<!DOCTYPE html><html lang="en"><head>
    ...
    <title>Admin — Students — PKU UTHM</title>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :root{--green-900:#14532d;--blue-600:#1d5bb5;--blue-500:#2563eb;--blue-50:#eff6ff;--blue-100:#dbeafe;--green-600:#16a34a;--green-100:#dcfce7;--amber-600:#d97706;--amber-100:#fef3c7;--red-600:#dc2626;--red-100:#fee2e2;--purple-600:#7c3aed;--purple-100:#ede9fe;--slate-900:#0f172a;--slate-700:#334155;--slate-500:#64748b;--slate-300:#cbd5e1;--slate-200:#e2e8f0;--slate-100:#f1f5f9;--slate-50:#f8fafc;--white:#fff;--sidebar-w:232px;--topbar-h:58px;--font:'Plus Jakarta Sans',sans-serif}
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo $dash; ?>" class="nav-link"><span class="ico"><i class="fa-solid fa-gauge"></i></span> Dashboard</a>
        <a href="queue_management.php" class="nav-link"><span class="ico"><i class="fa-solid fa-list-ol"></i></span> Queue Management</a>
        <a href="appointment_management.php" class="nav-link"><span class="ico"><i class="fa-solid fa-calendar-check"></i></span> Appointments</a>
        <div class="nav-section">Records</div>
        <a href="student_list.php" class="nav-link active"><span class="ico"><i class="fa-solid fa-users"></i></span> Students</a>
        <a href="reports.php" class="nav-link"><span class="ico"><i class="fa-solid fa-chart-bar"></i></span> Reports</a>
    ...
    <div class="sidebar-footer"><div class="user-card">
        ...
        <a href="logout.php" style="font-size:14px;color:rgba(255,255,255,0.3);text-decoration:none;margin-left:4px;" title="Logout"><i class="fa-solid fa-right-from-bracket"></i></a>
    </div></div>
</aside>
<header class="topbar">
    <div>
        <div class="topbar-title">Students</div>
        <div class="breadcrumb"><a href="<?php echo $dash; ?>">Dashboard</a><span class="sep">›</span><span>Student List</span></div>
    </div>
...
<div class="page"><div class="page-body">
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div><div class="stat-val" style="color:var(--green-600)"><?php echo $new_this_month; ?></div><div class="stat-lbl">New This Month</div></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon amber"><i class="fa-solid fa-magnifying-glass"></i></div>
            <div><div class="stat-val" style="color:var(--amber-600)"><?php echo count($students); ?></div><div class="stat-lbl">Search Results</div></div>
        </div>
    </div>
    <div class="filter-bar">
        <form method="GET"><div class="filter-row">
            ...
            <div style="display:flex;gap:8px;align-items:flex-end">
                <button type="submit" class="btn btn-primary" style="padding:9px 16px;"><i class="fa-solid fa-magnifying-glass"></i> Search</button>
                <a href="student_list.php" class="btn btn-outline" style="padding:9px 14px;"><i class="fa-solid fa-xmark"></i> Clear</a>
            </div>
        </div></form>
    </div>
...
<div class="modal-overlay" id="modal" onclick="if(event.target===this)this.classList.remove('active')">
    <div class="modal">
        <div class="modal-hd">
            <h3><i class="fa-solid fa-clock-rotate-left" style="color:var(--blue-600);margin-right:6px"></i>Patient History</h3>
